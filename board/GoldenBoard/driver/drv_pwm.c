...
static void _set(elab_pwm_t * const me, uint8_t duty_ratio);

/* private variables -------------------------------------------------------- */
static elab_pwm_t pwm_led3;
static elab_pwm_t pwm_led4;
static elab_pwm_t pwm_adc_in;
...
static void driver_pwm_init(void)
{
    ...
    {
        /* Device registering. */
        pwm_driver_data[i].device->super.user_data = &pwm_driver_data[i];
        _init(pwm_driver_data[i].device);
    }
    ...
    {
        /* Device registering. */
        elab_pwm_register(pwm_driver_data[i].device,
...
static void _init(elab_pwm_t * const me)
{
    eio_pwm_data_t *data = me->super.user_data;
